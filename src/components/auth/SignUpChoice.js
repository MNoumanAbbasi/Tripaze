     ...
     return (
        <div className="container">
            ...
            <div className="input-field">
                <Link to='/signupuser'><button className="btn blue lighten-1 z-depth-1">User</button></Link>
            </div>
            <div className="input-field">
                <Link to='/signupcompany'><button className="btn blue lighten-1 z-depth-1">Company</button></Link>
            </div>
        </div>            
     )
 }
